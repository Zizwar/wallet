    ...
    return new Promise((resolve_, reject_) => {
        ...
        axios(params).then(function ({ data = [] }) {
            ...
            $.querySelectorAll('tr').forEach(function (el) {
                ...
                const price = el.querySelector('td:nth-child(8)') && el.querySelector('td:nth-child(8)').innerText || "not found";

                const symbole = el.querySelector('td:nth-child(3)') && el.querySelector('td:nth-child(3)').innerText || "not found";
